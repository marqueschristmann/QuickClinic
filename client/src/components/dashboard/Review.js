    ...
    return (
        <Fragment>
            <div className="review-graph">
                ...
                <h2 class="credentials"><strong> Avaliações de Usuários</strong></h2>
                    <br />
                    <div id="testimonials">
                        <div class="scroll">
                            { review.length === 0 ? "Ainda não há Avliações" : reviews }
                        </div>
                    </div>
                </div>
                <div className="common-details">
                    <h2 className="credentials"><strong>Total de Agendamentos</strong></h2>
                    <br />
                    <div id="graph">
