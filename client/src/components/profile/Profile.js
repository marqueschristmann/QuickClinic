                            ...
                            <div class="container">
                                <div class="current-profile">
                                    <div class="current-btn">
                                        <Link class="rounded-pill btn btn-dark" to="/profiles">Voltar para Perfis</Link>
                                        {authUser.isUserAuthenticated ? (
                                            <Fragment>
                                                <Link to={`/appointment/${profileById.doctor._id}`} type="button" className="rounded-pill btn btn-info"><i className="fas fa-calendar-check"></i> Notas de Agendamentos</Link>
                                            </Fragment>
                                            ) : (
                                                <Fragment>
                                    ...
                                    <div className="exp-edu">
                                        <div className="exp-bottom">
                                            <h2 className="exp-common-heading">Serviços é Parceirias</h2>
                                            {profileById.experience.length > 0 ? (
                                                    ...
                                                    <h4> Sem Serviços é Parceirias</h4>
                                                )
                                            }
                                        </div>
                                        <div className="edu-bottom">
                                            <h2 className="exp-common-heading">Sobre</h2>
                                    ...
                                    <div class="patient-review">
                                            <h2 class="exp-common-heading">Comentários de pacientes</h2> 
                                            { authUser.isUserAuthenticated ? 
                                                (
